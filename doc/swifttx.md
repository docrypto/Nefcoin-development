...
This mechanism has been integrated into Bitcore-Node-NEF which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NEF-Project/insight-api-nef#web-socket-api](https://github.com/NEF-Project/insight-api-nef#web-socket-api) 
* API: [https://github.com/NEF-Project/insight-api-nef#swifttx-transactions](https://github.com/NEF-Project/insight-api-nef#swifttx-transactions) 
...
By default, the NEF Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NEF Core daemon:
