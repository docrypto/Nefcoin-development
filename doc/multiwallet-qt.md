...
In order to support loading of multiple wallets in nef-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nef.cpp.
...
Changes to nef.cpp
----------------------
nef.cpp is the entry point into nef-qt, and as such, will require some minor modifications to provide hooks for
