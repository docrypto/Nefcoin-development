                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NEF Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NEF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nef: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NEF Core"), this);
    aboutAction->setStatusTip(tr("Show information about NEF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NEF"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NEF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NEF addresses"));
    ...
    openAction->setStatusTip(tr("Open a NEF: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NEF Core help message to get a list with possible NEF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NEF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NEF network", "", count));
}
...
{
    QString strTitle = tr("NEF Core"); // default title
