...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"nef", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"nef", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nef", "mnsync", &mnsync, true, true, false},
        {"nef", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"nef", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nefd, or the -server option to nef-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nef-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43273/\n";
}
