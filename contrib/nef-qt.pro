...
RESOURCES += src/qt/nef.qrc src/qt/nef_locale.qrc

TRANSLATIONS += src/qt/locale/nef_bg.ts \
                src/qt/locale/nef_de.ts \
                src/qt/locale/nef_en.ts \
                src/qt/locale/nef_es.ts \
                src/qt/locale/nef_fi.ts \
                src/qt/locale/nef_fr.ts \
                src/qt/locale/nef_it.ts \
                src/qt/locale/nef_ja.ts \
                src/qt/locale/nef_pl.ts \
                src/qt/locale/nef_pt.ts \
                src/qt/locale/nef_ru.ts \
                src/qt/locale/nef_sk.ts \
                src/qt/locale/nef_sv.ts \
                src/qt/locale/nef_vi.ts \
                src/qt/locale/nef_zh_CN.ts \
                src/qt/locale/nef_zh_TW.ts
