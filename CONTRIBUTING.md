Contributing to NEF Core
============================

The NEF Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NEF Core project, and is not to be
confused with overall NEF Network Protocol consensus changes.

Whether a pull request is merged into NEF Core rests with the project merge
...
Patches that change NEF consensus rules are considerably more involved than
...
Where a patch set proposes to change the NEF consensus, it must have been
...
The project leader is the release manager for each NEF Core release.
